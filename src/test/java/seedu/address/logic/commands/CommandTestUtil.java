...
public class CommandTestUtil {
    ...
    public static final String VALID_PHONE_RANDOM = "97772221";
    ...
    public static final String PROJECT_DESC_X = " " + PREFIX_PROJECT + VALID_PROJECT_X;
    ...
    public static final String INVALID_PROJECT_DESC = " " + PREFIX_PROJECT + "project*"; // '*' not allowed in tags
